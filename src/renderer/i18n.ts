...
const messages = {
  'zh-CN': {
    ...
    autoSave: '修改后自动保存', saving: '保存中', saved: '已保存', saveFailed: '保存失败',
  ...
  'en-US': {
    ...
    language: 'Language', languageHint: 'Choose the display language for Ducky. The change takes effect immediately.', chinese: 'Simplified Chinese', english: 'English',
    ...
    autoSave: 'Changes save automatically', saving: 'Saving', saved: 'Saved', saveFailed: 'Could not save',
